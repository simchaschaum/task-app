    ...
    render(){
        ...
        return (
                    <div className="headerDiv" id={menuShow}>
                        ...
                        {/* Show Schedule/ Show Tasks Button */}
                        <div className="dropdown headerItem">
                            <Button id="dropdown-basic-button" className="headerButton showScheduleBtn" onClick={this.showHideSchedule}> 
                        ...
                        {/* Delete All Tasks Marked Done Button */}
                        <div className="dropdown headerItem toolTipContainer">
